...
!!!info
    The Ayaneo 2S requires firmware version 20241112 or later for proper sleep support.  Flashing instructions are available [here](https://wiki.steamfork.org/troubleshooting/#updating-bios-ayaneo).
